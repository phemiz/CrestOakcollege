      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 text-center md:text-left">
          ...
          <div className="md:col-span-1">
            <h3 className={`text-lg font-semibold ${theme.footer.accent} mb-4`}>Crestview College</h3>
            <p className="text-sm">
              Empowering the next generation of leaders in Health Science, Administration, and Technology.
            </p>
          </div>
          ...
          <div>
            ...
            <address className="not-italic text-sm space-y-3">
              <div className="flex items-center justify-center md:justify-start">
                  ...
                  <a href="mailto:info.crestviewcollege25@gmail.com" className={`hover:${theme.footer.accent}`}>info.crestviewcollege25@gmail.com</a>
              </div>
            </address>
        ...
        <div className="mt-8 border-t border-gray-700 pt-6 text-center text-sm text-gray-400">
          <p>&copy; {new Date().getFullYear()} Crestview College. All Rights Reserved.</p>
        </div>
      </div>
    </footer>
  );
