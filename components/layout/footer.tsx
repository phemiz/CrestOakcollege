...
export const Footer: React.FC = () => {
  return (
    <footer className="bg-brand-blue-dark text-slate-300 pt-16 pb-8 border-t border-slate-800">
      ...
      {/* Footer Bottom */}
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8 flex flex-col sm:flex-row justify-between items-center gap-4 text-xs font-semibold text-slate-500">
        <div>
          © {new Date().getFullYear()} CrestOak College. All rights reserved.
        </div>
