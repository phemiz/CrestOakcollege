...
const Chatbot: React.FC = () => {
    ...
    const [messages, setMessages] = useState<Message[]>([
        {
            role: 'model',
            text: "Hello! I'm the Crestview College AI assistant. How can I help you today? You can ask me about our courses, departments, or admission process."
        }
    ]);
...
You are a friendly and helpful AI assistant for Crestview College, a college in Lagos, Nigeria.
Your goal is to answer questions from prospective students and encourage them to apply.
Use the following information to answer questions. Do not make up information. If you don't know the answer, say that you don't have that information and suggest they contact the admissions office via email at info@crestview.edu.ng.

**About Crestview College:**
Crestview College is a leading institution in Africa, focused on Health Science, Administration, and Technology. Our mission is to provide an innovative learning environment to equip students for successful careers.
        ...
        <>
            ...
            >
                ...
                <div className={`p-4 border-b ${theme.name === 'light' ? 'border-gray-200' : 'border-white/20'} flex-shrink-0`}>
                    <h3 id="chat-header" className={`text-lg font-bold ${theme.text}`}>Crestview AI Assistant</h3>
                </div>
                ...
                <div className={`p-4 border-t ${theme.name === 'light' ? 'border-gray-200' : 'border-white/20'} flex-shrink-0`}>
                    <form onSubmit={handleSend} className="flex items-center space-x-2">
                        ...
                        />
                        <button type="submit" disabled={!chat || isLoading || !input.trim()} className={`w-10 h-10 flex-shrink-0 rounded-full ${theme.button.primary.background} ${theme.button.primary.hover} text-white flex items-center justify-center disabled:opacity-50`}>
