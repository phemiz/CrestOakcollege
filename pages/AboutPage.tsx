...
const AboutPage: React.FC = () => {
  ...
  useEffect(() => {
    document.title = 'About Us - Crestview College';
    const metaDescription = document.querySelector('meta[name="description"]');
    if (metaDescription) {
        metaDescription.setAttribute('content', 'Learn about the history, mission, vision, and leadership of Crestview College, a premier institution in Lagos, Nigeria.');
    }
  }, []);
