...
const BlogPage: React.FC = () => {
    ...
    useEffect(() => {
        document.title = 'Blog - CrestOAK College';
        const metaDescription = document.querySelector('meta[name="description"]');
        if (metaDescription) {
            metaDescription.setAttribute('content', 'Read the latest articles, news, and insights from the students and faculty at CrestOAK College.');
        }
    }, []);
