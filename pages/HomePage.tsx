...
const Hero: React.FC = () => {
    ...
    <div className={`${heroBg} text-white`}>
        ...
        <p className="mt-6 max-w-3xl mx-auto text-lg md:text-xl text-gray-200">
            Join CrestOAK College and embark on a journey of discovery, growth, and professional success in health, administration, and technology.
        </p>
...
const HomePage: React.FC = () => {
    ...
    const homePageSchema = {
        ...
        "url": "https://crestoak.edu.ng",
        "logo": "https://crestoak.edu.ng/logo.png",
        "contactPoint": {
            "@type": "ContactPoint",
        ...
        "sameAs": [
            "https://www.facebook.com/crestoakcollege",
            "https://www.twitter.com/crestoakcollege"
        ]
    };
