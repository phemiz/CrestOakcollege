...
const AdmissionsPortalPage: React.FC = () => {
  ...
  return (
    <PageWrapper title="Admissions Portal" subtitle="Apply to CrestOAK or track your existing application.">
      <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-12">
        {/* Application Form Section */}
        <div className={`${formBg} p-8 rounded-lg ${theme.card.shadow} ${theme.card.border}`}>
          <h2 className={`text-3xl font-bold ${theme.text} mb-6`}>Apply to CrestOAK</h2>
