...
const CodeAssistantPage: React.FC = () => {
    ...
    const handleEmailCode = () => {
        if (!activeCode) return;
        const subject = `Generated Code from CrestOAK Assistant`;
        const body = `Hello,\n\nPlease find the code generated by the CrestOAK Code Assistant below:\n\n---\n\n${activeCode}`;
        const mailtoLink = `mailto:support@crestoak.edu.ng?subject=${encodeURIComponent(subject)}&body=${encodeURIComponent(body)}`;
