        ...
        <div className={`py-12 sm:py-16 ${pageBg}`}>
             <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                <div className="text-center mb-12">
                    ...
                    <p className={`mt-4 max-w-2xl mx-auto text-lg ${theme.textMuted}`}>Fill out the form below to begin your journey with Crestview College.</p>
                </div>
                ...
                <div className={`max-w-2xl mx-auto p-8 rounded-2xl ${formBg} ${theme.card.shadow} ${theme.card.border}`}>
                     ...
                     <form onSubmit={handleSubmit} noValidate className="space-y-8">
                        ...
                        <fieldset>
                             ...
                             <div className="space-y-6">
                                <div className="relative">
                                    ...
                                    <input type="text" name="fullName" id="fullName" placeholder="Full Name" value={formData.fullName} onChange={handleInputChange} className={`${inputClasses(!!errors.fullName)} pl-12`} required />
                                </div>
                                ...
                                <div className="relative">
                                    ...
                                    <input type="email" name="email" id="email" placeholder="Email Address" value={formData.email} onChange={handleInputChange} className={`${inputClasses(!!errors.email)} pl-12`} required />
                                </div>
                                ...
                                <div className="relative">
                                    ...
                                    <input type="tel" name="phone" id="phone" placeholder="+234 801 234 5678" value={formData.phone} onChange={handlePhoneChange} className={`${inputClasses(!!errors.phone)} pl-12`} required />
                                </div>
                                {errors.phone && <p className="mt-1 text-sm text-red-600">{errors.phone}</p>}

                                <div>
                                    <span className={`block text-sm font-medium mb-2 ${theme.textMuted}`}>Gender</span>
                        ...
                        <fieldset>
                            ...
                            {errors.programType && <p className="mt-1 text-sm text-red-600">{errors.programType}</p>}
                        </fieldset>
                        ...
                        <fieldset>
                            ...
                            <div className="space-y-6">
                                <div className="relative">
                                    ...
                                    <select name="firstChoice" id="firstChoice" value={formData.firstChoice} onChange={handleInputChange} disabled={availableCourses.length === 0} className={`${inputClasses(!!errors.firstChoice)} pl-12 appearance-none`} required>
                                ...
                                <div className="relative">
                                    ...
                                    <div className={`absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none ${theme.textMuted}`}><BookOpenIcon className="w-5 h-5" /></div>
                                    <select name="secondChoice" id="secondChoice" value={formData.secondChoice} onChange={handleInputChange} disabled={availableCourses.length === 0} className={`${inputClasses(!!errors.secondChoice)} pl-12 appearance-none`}>
