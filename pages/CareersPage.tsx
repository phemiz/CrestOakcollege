...
const CareersPage: React.FC = () => {
    ...
    useEffect(() => {
        document.title = 'Careers - Crestview College';
        const metaDescription = document.querySelector('meta[name="description"]');
        if (metaDescription) {
            metaDescription.setAttribute('content', 'Explore career opportunities at Crestview College and join our team of dedicated professionals.');
        }
    }, []);
        ...
        <>
            ...
            <div className={`py-16 sm:py-24 ${theme.name === 'light' ? 'bg-gray-50' : theme.card.background}`}>
                <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                     ...
                     <p className={`text-center max-w-2xl mx-auto mb-8 ${theme.textMuted}`}>Find your next opportunity at Crestview College. We are always looking for talented individuals to join us.</p>
