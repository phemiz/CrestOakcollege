...
export const COMMUNITY_SUB_LINKS = [
  ...
  { name: 'Careers', path: '/careers', description: "Discover job opportunities at Crestview." },
];

export const SEARCHABLE_PAGES: SearchResultItem[] = [
    { id: 'home', type: 'Page', title: 'Home', description: 'Return to the Crestview College homepage.', path: '/' },
    ...
    { id: 'blog', type: 'Page', title: 'Blog', description: 'Read articles and insights from the Crestview community.', path: '/blog' },
    ...
    { id: 'apply', type: 'Page', title: 'Application Form', description: 'Your future starts here. Apply to Crestview College now.', path: '/apply' },
    { id: 'contact', type: 'Page', title: 'Contact Us', description: 'Get in touch with us for enquiries.', path: '/contact' },
    { id: 'admin', type: 'Page', title: 'Student & Staff Portals', description: 'Login for students and staff to manage college operations.', path: '/admin' },
    { id: 'donate', type: 'Page', title: 'Donate', description: 'Support Crestview College and contribute to our mission.', path: '/donate' },
