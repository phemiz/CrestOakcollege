...
import { ShieldAlert, Eye, Rocket, Award, ShieldCheck, CheckCircle2 } from "lucide-react";
            ...
            <div className="lg:col-span-5 flex justify-center">
              ...
              >
                ...
                <div className="text-center w-full border-t border-slate-200/60 pt-4">
                  ...
                  <p className="text-xs text-brand-red font-semibold uppercase tracking-wider mt-1">Affiliated Institution</p>
