...
$gallery = [
    ["id" => 1, "caption" => "Main Campus Administrative Block", "category" => "Campus", "url" => "/crestoak-poster.jpg"]
];
ob_end_clean();
echo json_encode(["success" => true, "status" => "success", "gallery" => $gallery, "items" => $gallery, "data" => $gallery]);
exit(0);
