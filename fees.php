...
$fees = [
    ['id' => 1, 'title' => 'Tuition Fee (CHEW)', 'amount' => 150000, 'department' => 'Health Sciences'],
    ['id' => 2, 'title' => 'Tuition Fee (Computer Science)', 'amount' => 120000, 'department' => 'Applied Technologies']
];

ob_end_clean();
echo json_encode(['success' => true, 'status' => 'success', 'fees' => $fees, 'data' => $fees]);
exit(0);
