...
if ($method === 'POST') {
    ...
    // ---------------------------------------------------------------
    // Student submits a manual bank-transfer claim against a specific
    // student_fees row. Creates a PENDING fee_payments row for the
    // bursar to confirm or reject; never marks a fee paid directly.
    // ---------------------------------------------------------------
