...
const BLOG_POSTS_KEY = 'crestoak_blog_posts';
const BLOG_CATEGORIES_KEY = 'crestoak_blog_categories';
...
const MOCK_INITIAL_POSTS: BlogPost[] = [
    {
        id: 'welcome-to-crestoak-innovators',
        title: 'Welcome to the CrestOAK Innovators Blog!',
        excerpt: 'We are thrilled to launch our new blog, a space for our community to share ideas, stories, and the latest happenings at CrestOAK College.',
        content: `We are thrilled to launch our new blog, a space for our community to share ideas, stories, and the latest happenings at CrestOAK College.
