...
export const HeroSection = () => {
  return (
    <section className="relative min-h-[85vh] flex items-center bg-slate-900 overflow-hidden py-16 lg:py-20">
      ...
      <div className="hidden sm:block absolute top-1/2 left-1/4 -translate-y-1/2 w-96 h-96 bg-brand-red/10 rounded-full blur-2xl pointer-events-none" />
      <div className="hidden sm:block absolute top-1/3 right-1/4 -translate-y-1/2 w-96 h-96 bg-brand-blue-light/10 rounded-full blur-2xl pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8 relative z-10 w-full grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
        ...
        <div className="lg:col-span-7 text-center lg:text-left flex flex-col gap-6">
          <div className="flex flex-wrap items-center justify-center lg:justify-start gap-2.5">
            <div
              className="inline-flex items-center gap-2 bg-red-500/25 border-2 border-red-400 text-red-200 shadow-[0_0_15px_rgba(239,68,68,0.45)] px-4 py-2 rounded-full font-bold text-xs uppercase tracking-wider w-fit"
            >
          ...
          {/* LCP Target: Rendered immediately without opacity-0 or CSS animation delays */}
          ...
          {/* Trust Badges */}
          <div className="mt-6 flex flex-wrap items-center justify-center lg:justify-start gap-5 text-[10px] text-slate-400 font-bold uppercase tracking-wider opacity-70">
        ...
        <div className="lg:col-span-5 flex justify-center items-center">
          <div className="relative bg-slate-800/80 border border-slate-700/60 p-8 rounded-3xl w-full max-w-sm overflow-hidden flex flex-col items-center justify-center gap-6 shadow-xl">
            <div className="hidden sm:block absolute top-0 right-0 w-24 h-24 bg-brand-gold/10 rounded-full blur-xl pointer-events-none" />
