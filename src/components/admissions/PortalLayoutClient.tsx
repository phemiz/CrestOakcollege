    ...
    <div className="min-h-screen bg-slate-900 text-slate-100 flex flex-col md:flex-row">
      ...
      <div className="md:hidden bg-slate-950 border-b border-slate-800 h-16 flex items-center justify-between px-4 sticky top-0 z-50">
        <div className="flex items-center gap-2">
          ...
          <span className="font-display font-bold text-sm tracking-wider uppercase text-white">CrestOak Apply</span>
        </div>
        <button
      ...
      >
        ...
        <div className="h-20 border-b border-slate-800 flex items-center justify-between px-6 shrink-0 bg-slate-950/50">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <span className="text-[10px] text-indigo-400 font-bold uppercase tracking-wider">Admissions</span>
            </div>
          </div>
        ...
        <nav className="flex-1 px-4 py-6 overflow-y-auto space-y-1.5 scrollbar-thin">
          ...
          <Link
            href="/admissions"
            className="flex items-center gap-3 px-4 py-3 rounded-xl text-xs font-bold text-slate-400 hover:bg-slate-900 hover:text-white"
          >
        ...
        <div className="p-4 border-t border-slate-800 bg-slate-950/80">
          <div className="flex items-center gap-3 mb-3 bg-slate-900/60 p-3 rounded-xl border border-slate-800/40">
            <div className="bg-indigo-600/15 border border-indigo-500/20 text-indigo-400 p-2 rounded-lg">
              <User className="h-4 w-4" />
            </div>
            <div className="min-w-0 flex-1">
              <p className="text-xs font-bold text-slate-200 truncate leading-none mb-1">{user.name}</p>
              <span className="inline-block text-[9px] bg-indigo-600/20 border border-indigo-500/30 text-indigo-400 font-bold uppercase tracking-widest px-1.5 py-0.5 rounded">
                APPLICANT
              </span>
            </div>
          </div>
